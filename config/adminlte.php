        ...
        'Datatables' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '//cdn.datatables.net/2.0.1/js/dataTables.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
        ...
        'Select2' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/select2-bootstrap-theme@0.1.0-beta.10/Gruntfile.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
